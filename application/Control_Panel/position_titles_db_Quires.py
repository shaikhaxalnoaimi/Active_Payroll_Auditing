...
def Fetch_All_Positions():
    ...
    """
    all_data = pd.DataFrame(system_high_ranking_positions.Fetch_All_Positions_dataframe(), columns=['PID', 'POSITION_TITLE', 'CREATED_BY','CREATED_DATE' ,'UPDATED_BY','UPDATED_DATE'])
