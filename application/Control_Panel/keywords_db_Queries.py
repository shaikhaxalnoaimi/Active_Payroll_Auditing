...
The filename is "keywords_db_Queries.py" and it is located in the "application/Control_Panel" directory. The purpose of this file is to contain functions that interact with the database to fetch, insert, edit, or delete keywords.

The file depends on the "system_keywords" module, which contains functions to interact with the database. The version of this module is not specified in the code.



"""

from ..models import system_keywords
...
def Fetch_All_Keywords():
    all_data = system_keywords.Fetch_All_Keywords_dataframe()
    return all_data
