...
def selectFormInitilization():
    ...
    selectform_master.directories.choices = [("", "--- Select Employee Master ---")] + [(full_path_master, file_master)
                                                                                        for
                                                                                        full_path_master, file_master in
                                                                                        zip(full_paths_master,
                                                                                            files_master)]
    # Payroll
    ...
    selectform_payroll.directories_payroll.choices = [("", "  --- Select Employee Payroll ---")] + [
        (full_path_payroll, file_payroll) for
        full_path_payroll, file_payroll in
