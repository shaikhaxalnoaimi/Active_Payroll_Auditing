...
// when val is focused add focused class for style
function focused(el) {
  if (el.parentElement.classList.contains('val-group')) {
    el.parentElement.classList.add('focused');
  }
}

// when val is focused remove focused class for style
...
if (document.querySelectorAll('.val-group').length != 0) {
  var allInputs = document.querySelectorAll('val.form-control');
...
window.onload = function() {
  ...
  var inputs = document.querySelectorAll('val');
...
// Resize navbar color depends on configurator active type_name of sidenav
...
// Deactivate sidenav type_name buttons on resize and small screens
